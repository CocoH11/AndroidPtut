...
public class InterventionDetailsViewModel extends AndroidViewModel {
    ...
    public void loadIntervention(long id){
        ...
        String[] columns = new String[]{_ID, COLUMN_NAME_TITLE, COLUMN_NAME_DESCRIPTION, COLUMN_NAME_DATE,
                ...
                PhoneRepairManagementContract.Client._ID, COLUMN_NAME_NAME, COLUMN_NAME_FIRST_NAME, PhoneRepairManagementContract.Part._ID, PhoneRepairManagementContract.Part.COLUMN_TYPE_NAMING, PhoneRepairManagementContract.Need._ID, PhoneRepairManagementContract.Need.COLUMN_NAME_QUANTITY};
        String[] whereArgs = new String[]{_ID};
        String selection = SQL_WHERE(whereArgs);
        String[] selectionArgs = new String[]{String.valueOf(id)};
        System.out.println(selectionArgs[0]);
        interventionRepository.find(newIntervention, columns, selection, selectionArgs);
        System.out.println(newIntervention.getPartsNeededs().get(0).getPart().getNaming());
